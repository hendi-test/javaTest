...
public class CtsDedicatedAccountUnsuccessRejectTotalAggExeJob extends AbstractReportJob {

  @Override
  public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
    log.info(
        "CtsDedicatedAccountUnsuccessRejectTotalAggExeJob execute method started");
    ...
    try {
      ...
      getReportBean().generateCtsTotalAggregationReport(atStartOfDay(currentDate),
          atEndOfDay(currentDate), TotalAggregationReportType.DA_UNSUCCESS_REJECT_TOTAL);
    ...
    log.info(
        "CtsDedicatedAccountUnsuccessRejectTotalAggExeJob execute method finished");
  }
